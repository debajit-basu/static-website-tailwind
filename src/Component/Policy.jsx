  ...
  return (
    <div className="mx-20 text-[#6b6e70]">
      <div className="flex justify-center flex-wrap">
        <p className="mt-3 text-xl">Privacy Policy for Nayanika Jewellers</p>
        <div>
          <div className="mb-5">
            <p className="text-xl font-bold">Privacy Policy</p>
            <p className="mb-2">Last updated: October 26, 2023</p>
            <p>
          ...
          <div className="mb-5">
            ...
            <div className="mb-3">
              <p className="font-bold text-lg">Interpretation</p>
              <p>
            ...
            <div className="mb-3">
              <p className="font-bold text-lg">Definitions</p>
              <p className="mx-2 font-semibold">
                For the purposes of this Privacy Policy:
              </p>
              <ul className="mx-10 flex flex-col gap-5 mt-5">
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    Nayanika Jewellers, Kolkata, West bengal.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Nayanika Jewellers,
                    accessible from{" "}
                    <a
                      href="https://nayanikajewellers.com"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://nayanikajewellers.com
                    </a>
                  </p>
                </li>
                <li>
          ...
          <div className="mb-3">
            ...
            <h3 className="font-bold text-xl mb-2">Types of Data Collected</h3>
            <h4 className="font-bold text-lg mb-2">Personal Data</h4>
            <p>
          ...
          <div className="mb-3">
            ...
            <ul className="mx-10 flex flex-col gap-5 my-5">
              <li>
          ...
          <div className="mb-3">
            <h3 className="font-semibold text-xl">Delete Your Personal Data</h3>
            <p>
          ...
          <div className="mb-3">
            ...
            <ul>
              <li>By email: nayanikajewellers@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
