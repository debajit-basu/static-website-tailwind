...
export default function TermCondition() {
  return (
    <div className="mx-20 text-[#6b6e70]">
      <div>
        <h3 className="flex justify-center font-bold text-xl">
          Preview your Terms &amp; Conditions
        </h3>
        <hr className="border-b border-b-gray-800 my-2" />
        <div>
          <h2>
            <strong>Terms and Conditions</strong>
          </h2>
          <p>Welcome to Nayanika jewellers!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Nayanika jewellers's Website, located at
            nayanikajewellers.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Nayanika jewellers if you do not
          ...
          <p>
            We employ the use of cookies. By accessing Nayanika jewellers, you
            agreed to use cookies in agreement with the Nayanika jewellers's
            Privacy Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Nayanika jewellers and/or its licensors own
            the intellectual property rights for all material on Nayanika
            jewellers. All intellectual property rights are reserved. You may
            access this from Nayanika jewellers for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Nayanika jewellers</li>
            <li>Sell, rent or sub-license material from Nayanika jewellers</li>
            <li>
              Reproduce, duplicate or copy material from Nayanika jewellers
            </li>
            <li>Redistribute content from Nayanika jewellers</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Nayanika jewellers does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Nayanika jewellers,its agents and/or
            ...
            applicable laws, Nayanika jewellers shall not be liable for the
          ...
          <p>
            Nayanika jewellers reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Nayanika jewellers a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Nayanika
          ...
          <p>
            ...
            sending an e-mail to Nayanika jewellers. Please include your name,
          ...
          <p>
            No use of Nayanika jewellers's logo or other artwork will be allowed
